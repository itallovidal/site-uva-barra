...
function handleApproveRegistration({ request, params }: { request: Request; params: PathParams }) {
...
export const approveRegistrationHandler = http.post('/registration/:id/approve', handleApproveRegistration);
